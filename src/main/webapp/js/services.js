iseeApp.factory('AuthenticationService', ['$http', '$cookieStore', '$rootScope', 'AjaxService', function($http, $cookieStore, $rootScope, AjaxService) {
	'use strict';
...
iseeApp.factory('AjaxService', [ '$rootScope', '$http', function($rootScope, $http) {
...
iseeApp.directive('access', ['AuthenticationService', function(AuthenticationService) {
	return {
        restrict: 'A',
...
iseeApp.directive('switch', function() {
    return {
		require: "ngModel",
        restrict: 'E',
        scope: {
