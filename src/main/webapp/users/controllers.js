iseeApp.controller('UsersController', [ '$scope', 'AjaxService', '$modal', 'AlertsService',
...
iseeApp.controller('AddUserController', [ '$scope', 'AjaxService', function($scope, AjaxService) {
    'use strict';
...
iseeApp.controller('GroupsController', [ '$scope', 'AjaxService', '$modal', 'AlertsService',
        function($scope, AjaxService, $modal, AlertsService) {
            'use strict';
...
iseeApp.controller('AddGroupController', [ '$scope', 'AjaxService', function($scope, AjaxService) {
    'use strict';
...
iseeApp.controller('GroupAuthoritiesController', [ '$scope', 'AjaxService', function($scope, AjaxService) {
    'use strict';
...
iseeApp.controller('GroupUsersController', [ '$scope', 'AjaxService', '$modal', function($scope, AjaxService, $modal) {
...
iseeApp.controller('AddUserToGroupController', [ '$scope', 'AjaxService', '$modal', function($scope, AjaxService, $modal) {
...
iseeApp.controller('ChangeUserController', [ '$scope', 'AjaxService', 'AuthenticationService',
        function($scope, AjaxService, AuthenticationService) {
            'use strict';
...
iseeApp.controller('RegisterUserController', [ '$scope', 'AjaxService', function($scope, AjaxService) {
    'use strict';
    ...
    $scope.save = function(request) {
        ...
        if (request.password != request.confirmPassword) {
            ...
            AjaxService.call('users/register', 'POST', request).success(function(data, status, headers, config) {
                $scope.addDialog.dismiss('cancel');
                $scope.load();
            });
        }
