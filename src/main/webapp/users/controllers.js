iseeApp.controller('UsersController', [ '$scope', 'AjaxService', '$modal', 'AlertsService', function($scope, AjaxService, $modal, AlertsService) {
    'use strict';
...
iseeApp.controller('GroupsController', [ '$scope', 'AjaxService', '$modal', 'AlertsService', function($scope, AjaxService, $modal, AlertsService) {
	'use strict';
...
iseeApp.controller('ChangeUserController', [ '$scope', 'AjaxService', 'AuthenticationService', function($scope, AjaxService, AuthenticationService) {
    'use strict';
